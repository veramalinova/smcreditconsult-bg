...
Формата на `/konsultaciya` изпраща заявки към `smcreditconsult@gmail.com` през FormSubmit (от браузера). Ако услугата е недостъпна, се отваря имейл клиент като резервен вариант.
