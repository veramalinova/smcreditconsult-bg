      ...
      sections: [
        {
          ...
          paragraphs: [
            "СМ Кредит Консулт предоставя независима ориентация и съдействие при избор и кандидатстване за ипотечен, потребителски или фирмен кредит — включително рефинансиране. Консултацията за клиента е безплатна.",
